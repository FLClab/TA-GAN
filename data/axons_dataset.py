...
class AxonsDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        seg_GT = Image.fromarray(image[2])
        ...
        seg_GT = image_transform(seg_GT)

        return {'confocal': confocal, 'STED': STED, 'seg_GT': seg_GT, 'image_paths': image_path}

...
class SynprotConfDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        conf561 = Image.fromarray(ABC[0,:,:])#.convert('L') ####
        conf640 = Image.fromarray(ABC[1,:,:])#.convert('L')

        #conf561 = conf561.resize((conf561.width * 4, conf561.height * 4), resample=Image.BICUBIC)
        #conf640 = conf640.resize((conf640.width * 4, conf640.height * 4), resample=Image.BICUBIC)

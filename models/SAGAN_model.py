...
class SAGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(norm='batch', netG='resnet_9blocks', netS='resnet_6blocks', dataset_mode='axons', batchsize=32, preprocess='flip_rotation', crop_size=128, name='SAGAN_{}'.format(datetime.date.today()))
        if is_train:
    ...
    def __init__(self, opt):
        ...
        self.netS = networks.define_stedfm(opt.init_type, opt.init_gain, self.gpu_ids)

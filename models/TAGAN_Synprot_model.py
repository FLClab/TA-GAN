...
class TAGANSynprotModel(BaseModel):
    """ This class implements the TA-GAN model for confocal to STED resolution enhancement for the synaptic proteins dataset.
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(norm='batch', netG='resnet_9blocks', netS='resnet_6blocks', dataset_mode='synprot', input_nc=2, output_nc=2)
        if is_train:
            parser.set_defaults(pool_size=0, gan_mode='vanilla', batch_size=32, niter=1000, niter_decay=0, preprocess='crop_rotation', crop_size=128, save_epoch_freq=100)
    ...
    def __init__(self, opt):
        ...
        #self.visual_names = ['real_conf561', 'real_conf640', 'real_sted561', 'real_sted640', 'fake_sted561', 'fake_sted640', 'seg_r561', 'seg_f561', 'seg_r640', 'seg_f640']
        #self.visual_names.append('seg_GT561')
        #self.visual_names.append('seg_GT640')
        self.visual_names = ['confocal', 'STED', 'fakeSTED', 'seg_GT', 'seg_STED', 'seg_fakeSTED']
